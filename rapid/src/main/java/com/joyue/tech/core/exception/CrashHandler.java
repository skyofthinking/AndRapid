...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        if (ex == null) {
            TLog.w(TAG, "handleException --- ex==null");
            return true;
        }
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            TLog.i(TAG, "FildDir " + mContext.getFilesDir());
            trace.flush();
            trace.close();
            return fileName;
        } catch (Exception e) {
            TLog.e(TAG, "an error occured while writing report file...", e);
        }
        return null;
    }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            TLog.e(TAG, "Error while collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                if (DEBUG) {
                    TLog.d(TAG, field.getName() + " : " + field.get(null));
                }
            } catch (Exception e) {
                TLog.e(TAG, "Error while collect crash info", e);
            }
        }
    }
